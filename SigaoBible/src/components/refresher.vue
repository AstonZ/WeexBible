<template>
    <refresh class="u-refresh" @refresh="onrefresh" @pullingdown="onpullingdown" :display="refreshing ? 'show' : 'hide'">
        ...
        <div class="l-txt-box">
            <text ref="lTxt1" class="l-txt l-txt-1">思</text>
            <text ref="lTxt2" class="l-txt l-txt-2">高</text>
            <text ref="lTxt3" class="l-txt l-txt-3">圣</text>
            <text ref="lTxt4" class="l-txt l-txt-4">经</text>
            <text ref="lTxt5" class="l-txt l-txt-5">读</text>
            <text ref="lTxt6" class="l-txt l-txt-6">本</text>
            <text ref="lTxt7" class="l-txt l-txt-7">。</text>
